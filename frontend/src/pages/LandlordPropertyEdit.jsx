  ...
  useEffect(() => {
    ...
    const loadProperty = async () => {
      try {
        ...
        setForm({
          rentalName: rental.rentalName || rental.name || '',
          rentalType: rental.rentalType || '',
          monthlyPrice: rental.monthlyPrice || rental.price || '',
  ...
  return (
    <div className="p-6">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-secondary-800">Edit Property</h1>
          <p className="text-secondary-500">Update property details</p>
        </div>
      </div>
...
export default LandlordPropertyEdit;